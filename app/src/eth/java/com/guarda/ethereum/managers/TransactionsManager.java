...
public class TransactionsManager {
    ...
    private HashMap<String, Integer> hashPositionMap = new HashMap<>();
    ...
    private void initHashPositionMap () {
        if (this.transactionsList != null) {
            int i = 0;
            for (TransactionResponse tr : this.transactionsList) {
                hashPositionMap.put(tr.getHash(), i);
                i++;
            }
        }
    }

    public HashMap<String, Integer> getHashPositionMap() {
        return this.hashPositionMap;
    }
