...
public class Common {
    ...
    public final static String NODE_ADDRESS = "https://eth.guarda.co";
    public final static String MAIN_CURRENCY = "eth";
    public final static String MAIN_CURRENCY_NAME = "ethereum";
    public final static String ETH_SHOW_PATTERN = "#,##0.#####";
    public final static String ETH_SHOW_PATTERN_EXT = "#,##0.########";
    ...
    public final static int DEFAULT_GAS_LIMIT_FOR_CONTRACT = 210000;

    public final static String TOKENS_FILE_NAME = "eth_tokens_request.json";
