...
public class Requestor {
    ...
    public static void getTransactions(String address, String apikey, ApiMethods.RequestListener listener){
        Call call = ApiMethods.createEtherScanApi().getTransactions(address, apikey);
        ApiMethods.makeRequest(call, listener);
    }

    public static void getTokenTransactions(String address, ApiMethods.RequestListener listener){
        Call call = ApiMethods.createEthplorerService().getTransactions(address);
        ApiMethods.makeRequest(call, listener);
    }

    public static void getTokensBalances(String address, String apikey, ApiMethods.RequestListener listener){
        Call call = ApiMethods.createEthplorerApi().getTokensBalances(address, apikey);
        ApiMethods.makeRequest(call, listener);
    }
    ...
    public static void getTokens(JsonArray param, ApiMethods.RequestListener listener){
        ...
        Log.d("svcom", "tokens request = " + call.request());
        ApiMethods.makeRequest(call, listener);
    }
    ...
    public static void getTokensInfo(ApiMethods.RequestListener listener) {
        Call call = ApiMethods.createGuardaEthApi().getTokensList();
        Log.d("Request", "path " + call.request());
        ApiMethods.makeRequest(call, listener);
    }
    ...
    public static void sendRawTransaction(JsonObject json, ApiMethods.RequestListener listener) {
    ...
    public static void getTokens(ApiMethods.RequestListener listener) {
        Call call = ApiMethods.createGuardaCoApi().getTokensList();
        Log.d("Request", "path " + call.request());
        ApiMethods.makeRequest(call, listener);
    }
}
