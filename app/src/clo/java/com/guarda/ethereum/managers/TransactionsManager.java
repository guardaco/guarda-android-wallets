...
public class TransactionsManager {
    ...
    public List<TransactionResponse> mapTxsFromArray(List<ArrayList<String>> txList) {
        List<TransactionResponse> txsRespList = new ArrayList<>();
        for (ArrayList<String> tx : txList) {
            txsRespList.add(new TransactionResponse(tx));
        }
        return txsRespList;
    }
