...
public class Common {
    ...
    public final static String NODE_ADDRESS = "https://clo.guarda.co";
    public final static String MAIN_CURRENCY = "clo";
    public final static String MAIN_CURRENCY_NAME = "callisto-network";
