...
import com.guarda.ethereum.sapling.rxcall.CallBlockRange;
import com.guarda.ethereum.sapling.rxcall.CallBlocksForSync;
import com.guarda.ethereum.sapling.rxcall.CallFindWitnesses;
import com.guarda.ethereum.sapling.rxcall.CallLastBlock;
import com.guarda.ethereum.sapling.rxcall.CallRevertLastBlock;
import com.guarda.ethereum.sapling.rxcall.CallSaplingParamsInit;
import com.guarda.ethereum.sapling.rxcall.CallValidateSaplingTree;
...
import static com.guarda.ethereum.sapling.SyncProgress.DOWNLOAD_PHASE;
import static com.guarda.ethereum.sapling.SyncProgress.SEARCH_PHASE;
import static com.guarda.ethereum.sapling.SyncProgress.SYNCED_PHASE;
...
//                                    validateSaplingTree();
    ...
    private SaplingBlockTree nearStateHeightForStartSync() {
        ...
        if (firsSyncBlockHeight == 0) {
            walletManager.setCreateHeight(FIRST_BLOCK_TO_SYNC_MAINNET_TESTNET);
            firsSyncBlockHeight = FIRST_BLOCK_TO_SYNC_MAINNET_TESTNET;
        }
