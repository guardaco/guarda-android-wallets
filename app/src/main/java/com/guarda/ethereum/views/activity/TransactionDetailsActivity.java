...
import com.guarda.ethereum.sapling.rxcall.CallGetMemo;
...
import static com.guarda.ethereum.models.constants.ZecExplorer.ZEC_EXPLORER_TX_TESTNET;
...
public class TransactionDetailsActivity extends AToolbarMenuActivity {
    ...
    public void onTransHashClick() {
        ...
        if (BuildConfig.FLAVOR.equals(MAINNET_FLAVOR)) {
            baseUrl = ZEC_EXPLORER_TX;
        } else {
            baseUrl = ZEC_EXPLORER_TX_TESTNET;
        }
        String hashDetailUrl = baseUrl + etHash.getText().toString();
