...
public class Common {
    ...
    public final static String BTC_NODE_PASS = "PA5TRrn-qkK07lltFK-atXTMmNGys8LWmTVUXfD1gqY=";
    public final static String NODE_ADDRESS = "http://sbtc.guarda.co:8332";
    public final static String MAIN_CURRENCY = "sbtc";
    public final static String MAIN_CURRENCY_NAME = "super-bitcoin";
