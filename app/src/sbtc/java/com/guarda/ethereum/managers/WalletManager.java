...
public class WalletManager {
    ...
    private static NetworkParameters params = new SBTCParams();
...
//            return "12zmVQ5geWPthumi2mcwBBDJCZhvCoL8rx"; // miner's address
//        }
...
//        sendRequest.setUseForkId(true);
    ...
    private static class SBTCParams extends MainNetParams{
        SBTCParams(){
            super();
            dnsSeeds = new String[]{"seed.superbtca.com", "seed.superbtca.info", "seed.superbtc.org"};
            port = 8334;
            checkpoints.put(Integer.valueOf(499060), Sha256Hash.wrap("000000000000000cdb7383336c6b76dccd482a93200ec6f842fc538fbff6e0dc"));
            checkpoints.put(Integer.valueOf(500448), Sha256Hash.wrap("00000000000000002f5918df71aaa2ef31c004c1273a50147786b12e2db923c1"));
        }
    }
