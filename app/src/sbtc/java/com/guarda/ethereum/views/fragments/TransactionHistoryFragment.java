...
public class TransactionHistoryFragment extends BaseFragment {
    ...
    private void loadTransactions() {
        RequestorBtc.getTransactionsSbtcNew(walletManager.getWalletFriendlyAddress(), new ApiMethods.RequestListener() {
            @Override
    ...
    private void loadBalance() {
        RequestorBtc.getBalanceSbtcNew(walletManager.getWalletFriendlyAddress(), new ApiMethods.RequestListener() {
            @Override
            public void onSuccess(Object response) {
                loaderAnimation.cancel();
