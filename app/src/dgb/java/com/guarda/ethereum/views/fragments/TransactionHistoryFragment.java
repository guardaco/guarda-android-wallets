...
public class TransactionHistoryFragment extends BaseFragment {
    ...
    private void loadTransactions() {
        RequestorBtc.getTransactionsDgbNew(walletManager.getWalletFriendlyAddress(), new ApiMethods.RequestListener() {
            @Override
    ...
    private void loadBalance() {
        RequestorBtc.getBalanceDgbNew(walletManager.getWalletFriendlyAddress(), new ApiMethods.RequestListener() {
            @Override
            public void onSuccess(Object response) {
                loaderAnimation.cancel();
