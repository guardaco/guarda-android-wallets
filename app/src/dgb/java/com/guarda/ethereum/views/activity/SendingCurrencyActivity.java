...
//    private BigDecimal balance = new BigDecimal(0);
    ...
    private static final BigDecimal avgTxSizeKb = new BigDecimal("5.705");
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        if (walletManager.getWalletFriendlyAddress() == null) {
            Toast.makeText(getApplicationContext(), "Can't get UTXO update. Your address is empty", Toast.LENGTH_LONG).show();
            return;
        }

        RequestorBtc.getUTXOListDgbNew(walletManager.getWalletFriendlyAddress(), new ApiMethods.RequestListener() {
            @Override
            public void onSuccess(Object response) {
                List<UTXOItemDgb> utxos = (List<UTXOItemDgb>)response;
                walletManager.setUTXO(utxos);
            ...
            public void onFailure(String msg) {
                Toast.makeText(getApplicationContext(), "Can not get UTXO update", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initFeeField() {
        Coin defaultFee = Coin.valueOf(100000);
            ...
            if (!amount.isEmpty()) {
                if (!isAmountMoreBalance(amount)) {
                    ...
                    if (hex.equals(WalletManager.SMALL_SENDING)) {
                        ...
                        RequestorBtc.broadcastRawTxDgbNew(hex, new ApiMethods.RequestListener() {
                            @Override
                            public void onSuccess(Object response) {
