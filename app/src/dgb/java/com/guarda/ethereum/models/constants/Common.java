...
public class Common {
    ...
    public final static String NODE_ADDRESS = "https://dgb.guarda.co";
    public final static String MAIN_CURRENCY = "dgb";
    public final static String MAIN_CURRENCY_NAME = "DigiByte";
