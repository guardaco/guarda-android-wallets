...
public class TransactionDetailsActivity extends AToolbarMenuActivity {
    ...
    private static final String BLOCK_EXPLORER_URL = "http://bitshares-explorer.io/#/blocks/";
    ...
    public void onRepeatTransactionClick() {
        ...
        String userName = transaction.getTo();
        userName = BtsManager.getInstance().get_account_name_by_id(userName);
        intent.putExtra(Extras.WALLET_NUMBER, userName);
