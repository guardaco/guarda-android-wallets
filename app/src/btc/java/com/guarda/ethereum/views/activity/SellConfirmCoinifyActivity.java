...
public class SellConfirmCoinifyActivity extends AToolbarActivity {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        send.setText(String.format(Locale.getDefault(), "%f %s", getIntent().getFloatExtra(Extras.COINIFY_IN_AMOUNT, 0.0f), getIntent().getStringExtra(Extras.COINIFY_IN_AMOUNT_CUR)));
...
//                    changeNowGenAddr(ctr.getTransferIn().getDetails().getAccount());
                    getTxFee(walletManager.getWalletFriendlyAddress());
            ...
            if (hex.equals(WalletManager.SMALL_SENDING)) {
                ...
                BitcoinNodeManager.sendTransaction(hex, new ApiMethods.RequestListener() {
                    ...
                    public void onFailure(String msg) {
                        ...
                        Toast.makeText(getApplicationContext(), "Error while sending transaction", Toast.LENGTH_LONG).show();
                    }
                });
            }
