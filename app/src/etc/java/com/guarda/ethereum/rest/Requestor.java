...
public class Requestor {
    ...
    public static void getTransactions(String address, ApiMethods.RequestListener listener) {
        if (address != null) {
            Call call = ApiMethods.createEtcchainApi().getTransactions(address);
            ApiMethods.makeRequest(call, listener);
        }
    }


    public static void getTransactionsGastracker(String address, ApiMethods.RequestListener listener) {
        if (address != null) {
            Call call = ApiMethods.createGastrackerApi().getTransactions(address);
            ApiMethods.makeRequest(call, listener);
        }
    }
    ...
    public static void getTokensInfo(ApiMethods.RequestListener listener) {
        Call call = ApiMethods.createGuardaEtcApi().getTokensList();
        Log.d("Request", "path " + call.request());
        ApiMethods.makeRequest(call, listener);
    }
