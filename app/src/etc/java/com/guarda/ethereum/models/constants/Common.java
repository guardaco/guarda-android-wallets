...
public class Common {
    ...
    public final static String NODE_ADDRESS = "https://etc.guarda.co";
    public final static String MAIN_CURRENCY = "etc";
    public final static String MAIN_CURRENCY_NAME = "ethereum-classic";
