...
//                    findViewById(R.id.btn_max).setVisibility(View.VISIBLE);
    ...
    private void updateEthBalance() {
        balance = new BigDecimal(walletManager.getMyBalance().toPlainString());
    ...
    private boolean isAmountMoreBalance(String amount) {
        ...
        Log.d("flint", "AmountToSendActivity.isAmountMoreBalance()... balance="+balance + ", amountDecimal="+amountDecimal);
