...
public class Common {
    ...
    public final static String BLOCK = "-";//"lolaspekt";
    ...
    public final static String MAIN_CURRENCY = "dct";
    ...
    public final static int DEFAULT_GAS_LIMIT = 100000;
    public final static int DEFAULT_GAS_LIMIT_FOR_CONTRACT = 100000;
