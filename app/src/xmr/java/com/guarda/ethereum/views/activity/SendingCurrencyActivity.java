...
//    private BigDecimal balance = new BigDecimal(0);
    ...
    private static final BigDecimal avgTxSizeKb = new BigDecimal("0.650");
        ...
        try {
            ...
            if (!amount.isEmpty()) {
                if (!isAmountMoreBalance(amount)) {
                    ...
                    WalletAPI.sendTransactionFromName("u"+Coders.md5(sharedManager.getWalletEmail()), Coders.decodeBase64(sharedManager.getLastSyncedBlock()), "u"+Coders.md5(getToAddress()), amountSatoshi, currentFeeEth, new Callback<Boolean>() {
                        @Override
