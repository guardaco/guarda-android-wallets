...
public class Common {
    ...
    public final static String NODE_ADDRESS = "https://bch.guarda.co";
    public final static String MAIN_CURRENCY = "bch";
    public final static String MAIN_CURRENCY_NAME = "bitcoin-cash";
    ...
    public final static BigDecimal AVG_TX_SIZE_KB = new BigDecimal("0.401");
}
