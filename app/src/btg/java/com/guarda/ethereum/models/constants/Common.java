...
public class Common {
    ...
    public final static String BTC_NODE_PASS = "AQKE4xb6Vh29vNqyZk6Tkb2EGLTzyZ";
    public final static String NODE_ADDRESS = "https://btg.guarda.co";
    public final static String MAIN_CURRENCY = "btg";
    public final static String MAIN_CURRENCY_NAME = "bitcoin-gold";
    ...
    public final static BigDecimal AVG_TX_SIZE_KB = new BigDecimal("5.705");
}
