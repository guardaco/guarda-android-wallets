...
public class TransactionHistoryFragment extends BaseFragment {
    ...
    private void loadTransactions() {
        RequestorBtc.getTransactionsBtgNew(walletManager.getWalletFriendlyAddress(), new ApiMethods.RequestListener() {
            @Override
    ...
    private void loadBalance() {
        RequestorBtc.getBalanceBtgNew(walletManager.getWalletFriendlyAddress(), new ApiMethods.RequestListener() {
            @Override
            public void onSuccess(Object response) {
                loaderAnimation.cancel();
